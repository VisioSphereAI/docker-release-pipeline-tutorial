...
class TestSystemMonitoring:
    ...
    def test_cpu_info_api(self, client):
        ...
        assert "system" in data
        assert "cpu_info" in data
        assert "physical_cores" in data["cpu_info"]
        assert "logical_cores" in data["cpu_info"]
        assert "total_usage" in data["cpu_info"]

    def test_memory_info_api(self, client):
        ...
        assert "system" in data
        assert "memory_info" in data
        assert "total" in data["memory_info"]
        assert "used" in data["memory_info"]
        assert "percent" in data["memory_info"]

    def test_disk_info_api(self, client):
